...
create table tudla_prods_new as
select * from (
select a.site_id_number, a.duns_number, a.confidence_code, 'IBM' product_code,'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_ibm = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'JDE' product_code,'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_jde = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'MICROSOFT' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_microsoft = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'ORACLE' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_oracle = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'PSFT' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_psft = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'SAP' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_sap = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'SIEBEL' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.app_siebel = 1
-- DMBS
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'DB2' product_code, 'DBMS' product_type
from tudla_std_prod_final a
where a.db2 = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'ORACLE' product_code, 'DBMS' product_type
from tudla_std_prod_final a
where a.oracle = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'MS_SQL' product_code, 'DBMS' product_type
from tudla_std_prod_final a
where a.ms_sql = 1
--- MAIN APPLICATION
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'BI' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.bi = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'CRM' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.crm = 1
union all
select a.site_id_number, a.duns_number, a.confidence_code, 'ERP' product_code, 'APPLICATIONS' product_type
from tudla_std_prod_final a
where a.erp = 1
)
...
from tudla_prods_new a;
grant select on tudla_prods_leg_tmp to tudla;
